...
public class FlipLoadingLayout extends LoadingLayout {
	...
	protected void onLoadingDrawableSet(Drawable imageDrawable) {
		if (null != imageDrawable) {
			 ...
			 */
			ViewGroup.LayoutParams lp = iv_inner.getLayoutParams();
			lp.width = lp.height = Math.max(dHeight, dWidth);
			iv_inner.requestLayout();
			...
			iv_inner.setImageMatrix(matrix);
		}
	}
	...
	protected void pullToRefreshImpl() {
		...
		if (mRotateAnimation == iv_inner.getAnimation()) {
			iv_inner.startAnimation(mResetRotateAnimation);
		}
	}
	...
	protected void refreshingImpl() {
		...
		iv_inner.setVisibility(View.INVISIBLE);
