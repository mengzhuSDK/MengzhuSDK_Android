...
public class PinnedHeaderListView extends ListView implements OnScrollListener {
	...
	private OpenClick mOpen;

	public void isOpenClick(boolean isClick, int r, OpenClick open) {
...
//					Log.i("headerTop <= 0", "isClick"+isClick);
